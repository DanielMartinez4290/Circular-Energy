...
<br>
	...
	function circ_agent_constants(){
	    ...
	    $response12 =wp_remote_retrieve_body(wp_remote_get('https://circularenergy.quickbase.com/db/bjjrvv9zn?a=API_DoQuery&ticket='.$quickbaseticket.'&apptoken='.$quickbasetoken.'&includeRids=1'));
...
<br>
<form action="../wp-admin/admin.php?page=feas-study-fspdf" method="post">
	Company: 
